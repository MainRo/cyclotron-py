...
def make_crossbar(source):
    ...
    def on_sink_subscribe(observer):
        ...
        crossbar_subscribe(sink_observer, response_observer, request_observable)
    ...
    def crossbar_subscribe(sink_observer, response_observer, request):
    ...
    return Observable.create(on_sink_subscribe), crossbar
